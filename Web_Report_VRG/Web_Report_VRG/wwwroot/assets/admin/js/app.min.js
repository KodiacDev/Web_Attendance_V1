...
var handleThemePanel = function() {
	...
	elmList.map(function(elm) {
		elm.onclick = function(e) {
			...
			if (Cookies) {
				SetCookie(app.themePanel.cookieName, targetExpand, 30);
	...
	elmList.map(function(elm) {
		elm.onclick = function() {
			...
			if (Cookies) {
				SetCookie(app.themePanel.theme.cookieName, targetTheme, 30);
	...
	elmList.map(function(elm) {
		elm.onclick = function(e) {
			...
			if (Cookies) {
				SetCookie(app.themePanel.themeCover.cookieName, targetTheme, 30);
	...
	elms.map(function(elm) {
		elm.onclick = function(e) {
			...
			if (Cookies) {
				SetCookie(app.themePanel.themeMode.cookieName, targetMode, 30);
